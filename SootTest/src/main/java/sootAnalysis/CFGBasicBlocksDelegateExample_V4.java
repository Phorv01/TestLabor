...
public class CFGBasicBlocksDelegateExample_V4 {
	...
	public static void main(String[] args) // throws IOException
	{
		...
		for (Block head : graphHeads) {
			HashMap<Block, List<String>> myResult = graphIterator(g, head, graphTails,
					new HashMap<Block, List<String>>(), setVariables, getVariables, new ArrayList<String>());
	...
	public static HashMap<Block, List<String>> graphIterator(BlockGraph graph, Block head, List<Block> blockTails,
			HashMap<Block, List<String>> visitedBoxOut, List<String> setVariables, List<String> getVariables, List<String> removeVariables) {
...
//							functions.add("getVariable");
		...
		List<String> setNewVariables = new ArrayList<>();
		setNewVariables.addAll(variables);
		
		HashMap<Block, List<String>> newOut = new HashMap<Block, List<String>>();
		newOut.put(head, setNewVariables);
		...
		for (Block s : successors) {
			...
			if (visitedBoxOut.containsKey(s)) {
				if (!newOut.get(head).equals(visitedBoxOut.get(head))) {
					...
					visitedBoxOut.put(head, setNewVariables);
					setVariables.addAll(setNewVariables);
					graphIterator(graph, s, blockTails, visitedBoxOut, setVariables, getVariables, removeVariables);
				}
...
//	public static HashMap<Block, HashMap<String, List<String>>> blockIteraror(Block block, HashMap<Block, List<String>> setVariables, List<String> getVariables) {
//
//		List<String> variables = new ArrayList<String>();
//
