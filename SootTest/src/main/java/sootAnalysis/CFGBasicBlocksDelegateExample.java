...
public class CFGBasicBlocksDelegateExample {
	...
	public static void main(String[] args) // throws IOException
	{
		...
		argsList.addAll(Arrays.asList(new String[] { "-w", "-allow-phantom-refs" }));
	...
	public static void classFetcher(String className, String methodName) {		
		...
		for (Block head : graphHeads) {
			graphIterator(cg, g, head, graphTails, new HashMap<Block, List<String>>());
	...
	public static List<String> blockIteraror(CallGraph cg, Block block) {
String lookedpackage = "delegateBean";
			...
			if (unit instanceof AssignStmt || unit instanceof InvokeStmt) {
				...
				if (unit instanceof InvokeStmt) {
					...
					while (sources.hasNext()) {
						...
						if(packageName.equals(lookedpackage)) {
							G.reset();
