...
public class UseOriginalNames {
	...
	public static void main(String args[]) {
	    ...
	    Scene.v().addBasicClass("delegateExamples.CreateCollectionDelegate",SootClass.BODIES);
//
...
//		}
		...
		SootClass c = Scene.v().getSootClass("delegateExamples.CreateCollectionDelegate");
