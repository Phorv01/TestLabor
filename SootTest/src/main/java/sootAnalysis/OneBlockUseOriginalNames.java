...
public class OneBlockUseOriginalNames {
...
//		Options.v().set_src_prec(4);
		...
		System.setProperty("soot.class.path", "D:\\Projects\\TestLabor\\SootTest\\src\\main\\java;D:\\Projects\\TestLabor\\SootTest\\target\\classes;C:\\Program Files\\Java\\jdk1.8.0_161\\jre\\lib\\rt.jar;"
	    ...
	    Scene.v().addBasicClass("delegateExamples.OneBlokDelegateExample",SootClass.SIGNATURES);

		SootClass c = Scene.v().loadClassAndSupport("delegateExamples.OneBlockDelegateExample");
...
//		SootClass c = Scene.v().getSootClass("delegateExamples.SimpleDelegateExample");
